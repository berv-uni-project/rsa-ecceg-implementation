...
public class ECCEGMain {
    ...
    private static void encryptFile(ECC ecc, String public_key_filepath, String filepath_plain,
    ...
    private static void decryptFile(ECC ecc, String private_key_filepath,
